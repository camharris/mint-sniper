...
interface NFT {
    slug: string;
    mintFunc: string; //() => null;
    transferFunc: string; // () => null;
    numToMint: number;
    abi: any;
}
...
if (NETWORK == "mainnet") {
    constants.PROVIDER_WSS =
        "wss://mainnet.infura.io/ws/v3/4c975d4f46b74da09a345e92ddace875";
...
if (NETWORK == "goerli") {
    constants.PROVIDER_WSS =
        "wss://goerli.infura.io/ws/v3/4c975d4f46b74da09a345e92ddace875";
    constants.FLASHBOTS_ENDPOINT = "https://relay-goerli.flashbots.net";
    constants.PUBLIC_WALLET = "0xb1d9f6aa8cA5b5e37FdceA9a5891bc11Ad6B0322";
    constants.NFTS = {
...
if (NETWORK == "rinkeby") {
    constants.PROVIDER_WSS =
        "wss://rinkeby.infura.io/ws/v3/4c975d4f46b74da09a345e92ddace875";
    constants.FLASHBOTS_ENDPOINT = "https://relay-goerli.flashbots.net";
    constants.PUBLIC_WALLET = "0xb1d9f6aa8cA5b5e37FdceA9a5891bc11Ad6B0322";
...
export const NFTS: Array<NFT> = constants.NFTS;
