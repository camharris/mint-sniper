...
contract Tubbies is ERC721A, MultisigOwnable, BatchReveal {
    ...
    constructor(string memory _baseURI, string memory _unrevealedURI, address _linkToken, address _linkCoordinator)
        ERC721A("Tubby Cats", "TUBBY")
    {
        ...
        startSaleTimestamp = block.timestamp - 10 days;
